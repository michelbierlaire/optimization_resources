...
An example is given by the following optimization problem in standard form:
...
The degenerate feasible basic solution $x^T = (0, 0, 0, 2)$ does not have any feasible basic direction. This is the only feasible solution of the problem, and therefore also the optimal solution.
